$.get('https://cdn.jsdelivr.net/gh/xiamian1012/echarts@store/json/analysis_all.json', function (jsonData) {
    const company_globe_analysis = new Vue({
        el: '#company_globe_analysis',
        data() {
        ...
        methods: {
            ...
            drawTab5Chart() {
                const mychart5 = echarts.init(document.getElementById('chart-six-one'))
                const mychart6 = echarts.init(document.getElementById('chart-six-two'))
                const mychart7 = echarts.init(document.getElementById('chart-six-three'))
                //const mychart8 = echarts.init(document.getElementById('chart8'))
                const mychart9 = echarts.init(document.getElementById('chart-six-five'))
                const mychart10 = echarts.init(document.getElementById('chart-six-six'))
            ...
            drawTab6Chart() {
                var that = this;
                const mychart8 = echarts.init(document.getElementById('chart-six-four'))
...
$.get('https://cdn.jsdelivr.net/gh/xiamian1012/echarts@store/json/population.json', function (geoData) {
    const mychart11 = echarts.init(document.getElementById('chart-company-globe'))
