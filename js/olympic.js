const app = new Vue({
    ...
    mounted() {
        this.drawTab1Chart(this.season_name);
    },
    methods: {
        drawTab1Chart(season_name_vars) {
                ...
                $.get('https://cdn.jsdelivr.net/gh/xiamian1012/echarts@store/json/world_geo.json', function (jsonData) {
                 ...
                 $.get('https://cdn.jsdelivr.net/gh/xiamian1012/echarts@store/json/flag_and_color_new.json', function (setting_data) {
                    ...
                    function getOption() {
                        ...
                        var female_svg = "path://m354.6663,136.27749c12.57,0 22.77211,-10.90121 22.77211,-24.34942c0,-13.45577 -10.20211,-24.36452 -22.77211,-24.36452c-12.58061,0 -22.78622,10.90875 -22.78622,24.36452c0,13.44821 10.20209,24.34942 22.78622,24.34942zm63.86637,105.0123l-20.43597,-81.04398c-0.19056,-0.7358 -0.45879,-1.43764 -0.78341,-2.08666c-2.32205,-7.59198 -8.98817,-13.08974 -16.86119,-13.08974l-51.72335,0c-8.20827,0 -15.10029,5.96944 -17.12938,14.07082c-0.13763,0.35469 -0.25055,0.72826 -0.35288,1.11313l-20.0725,81.04021c-1.33748,5.31286 1.6127,10.7729 6.58846,12.20301c4.96874,1.42255 10.07511,-1.73197 11.41258,-7.04482l15.76367,-63.66018l6.56732,0l-28.60896,115.18147l26.95746,0l0,79.51954c0,6.1166 4.62992,11.071 10.35736,11.071c5.71332,0 10.35384,-4.95064 10.35384,-11.071l0,-79.51954l8.2365,0l0,79.51954c0,6.1166 4.63698,11.071 10.36444,11.071c5.71331,0 10.35384,-4.95064 10.35384,-11.071l0,-79.51954l26.94329,0l-28.71481,-115.18147l6.74025,0l16.05302,63.66018c1.33746,5.31286 6.44384,8.46737 11.41253,7.04482c4.95814,-1.4301 7.90831,-6.8939 6.57791,-12.20678l-0.00001,0z"

                        var gold_text = setting_data.gold_text
                         console.log(male_svg)
                       ...
                       var counytry_color_value = Object.values(color_data)
                        ...
                        var distinct_text = alasql(" column of select distinct [3] from ? where [1]=" + "'" + season_name_vars + "' order by [1]", [base_data])
