$.get('https://cdn.jsdelivr.net/gh/xiamian1012/echarts@store/json/analysis_all.json', function (jsonData) {
  ...
  const mychart11 = echarts.init(document.getElementById('chart11'))
	...
	var ROOT_PATH1 = 'https://cdn.jsdelivr.net/gh/xiamian1012/echarts@store/texture';
        ...
        xAxis3D: [{ grid3DIndex: 0, max: 10, min: -10 }, { grid3DIndex: 1, max: 10, min: -10 }],
        yAxis3D: [{ grid3DIndex: 0, max: 10, min: -10 }, { grid3DIndex: 1, max: 10, min: -10 }],
        zAxis3D: [{ grid3DIndex: 0, max: 10, min: -10 }, { grid3DIndex: 1, max: 10, min: -10 }],
	                            grid3D: [{
